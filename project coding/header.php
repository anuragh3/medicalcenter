...
<center><a href="index.php"><img src="images/logo.jpg"></a></center>
<?php
if(!isset($_SESSION))
{ ?>
  <div id="head">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="patientlogin.php" <?php if(basename($_SERVER['PHP_SELF']) == "patientlogin.php"){ echo ' class="active"'; } ?>>Patient Login</a></li>
        <li><a href="doctorlogin.php" <?php if(basename($_SERVER['PHP_SELF']) == "doctorlogin.php"){ echo ' class="active"'; } ?>>Doctor Login</a></li>
        <li><a href="adminlogin.php" <?php if(basename($_SERVER['PHP_SELF']) == "adminlogin.php"){ echo ' class="active"'; } ?>>Admin Login</a></li>
