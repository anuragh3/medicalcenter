...
<div class="wrapper col2">
  <div id="breadcrumb"><b>Doctor Login Panel</b></div>
</div>
<div class="wrapper col4">
  <div id="container">
    <h1>Kindly Enter Registration ID and Password..</h1>
   <form method="post" action="" name="frmdoctlogin" onSubmit="return validateform()">
    <table width="200" border="3">
      <tbody>
        <tr>
          <td width="34%">Registration ID</td>
        ...
        <tr>
          <td height="36" colspan="2" align="center"><strong><!-- New user<br> -->
              <a href="index.php">Back</a>  </strong> 
              <!-- |  -->
              <!-- <a href="patientforgotpassword.php"><strong>Forgot Password</strong></a></td> -->
        </tr>
      </tbody>
    </table>
    </form>
