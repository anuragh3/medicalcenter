...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE medicine SET medicinename='$_POST[medicinename]',medicinecost='$_POST[medicinecost]',description='$_POST[description]',status='$_POST[status]' ,agent_id='$_POST[agent_id]',agent_name='$_POST[agent_name]',address='$_POST[address]' WHERE medicineid='$_GET[editid]'";
	...
	{
		// var_dump($_POST);
		$sql ="INSERT INTO medicine(medicinename,medicinecost,description,status,agent_id,agent_name,address) values('$_POST[medicinename]','$_POST[medicinecost]','$_POST[description]','$_POST[status]','$_POST[agent_id]','$_POST[agent_name]','$_POST[address]')";
		if($qsql = mysqli_query($con,$sql))
		{
  ...
  <div id="container">
    ...
    <table width="418" border="3">
      <tbody>
        ...
        <td width="34%">Agent Id</td>
          <td width="66%"><input type="text" name="agent_id" id="medicinename" value="<?php echo $rsedit[agent_id]; ?>" /></td>
        </tr>
        <tr>
          <td width="34%">Agent Name</td>
          <td width="66%"><input type="text" name="agent_name" id="medicinecost" value="<?php echo $rsedit[agent_name]; ?>" /></td>
        </tr>
        <tr>
          <td>Agent Address</td>
