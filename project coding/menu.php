...
<a href=" ######### ">Management</a>
    <ul>
        ...
        <li><a href="stationary.php" style="width:150px;">Add Stationary</a></li>
        <li><a href="viewstationary.php" style="width:150px;">View Stationary</a></li>
      </ul>
</li>
<li>
<a href=" ######### ">Reports</a>
    <ul>
        ...
        <li><a href="userReport.php" style="width:150px;">User Report</a></li>
       	<li><a href="patientReport.php" style="width:150px;">Patient Report</a></li>
        <li><a href="billingReport.php" style="width:150px;">Billing Report</a></li>
        <li><a href="medicineReport.php" style="width:150px;">Medicine Report</a></li>
        <li><a href="availMedicine.php" style="width:150px;">Available Medicine's</a></li>
      </ul>
</li>
...
<a href=" ######### ">Certificates</a>
    <ul>
       <li><a href="certificate.php">View Issued Certificates</a></li>
    </ul>
</li>
